...
static constexpr const AxisName nameMouseX{"Mouse.X"};
...
void updateGLFWAxisMap(GLFWwindow* window, AxisMap& axisMap, double mouseScrollX, double mouseScrollY)
{
...

    {
        ...
        axisMap[nameMouseX] = mouseX;
        axisMap[nameMouseY] = mouseY;

        axisMap[nameMouseScrollX] = mouseScrollX;
        axisMap[nameMouseScrollY] = mouseScrollY;
    }
